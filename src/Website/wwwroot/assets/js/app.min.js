    ...
    (function (i) {
        ...
        (t.prototype.selectOptionsFromConfig = function () {
            ...
            t &&
                ...
                i("input[type=checkbox][name=color-scheme-mode][value=" + t.mode + "]").prop("checked", !0),
                ...
                i("input[type=checkbox][name=leftsidebar-size][value=" + t.sidebar.size + "]").prop("checked", !0),
                i("input[type=checkbox][name=topbar-color][value=" + t.topbar.color + "]").prop("checked", !0));
        }),
        ...
        (t.prototype._saveConfig = function (t) {
            ...
            (t.prototype.loadConfig = function () {
                var t = JSON.parse(this.body.attr("data-layout") ? this.body.attr("data-layout") : "{}"),
                    e = n.extend({}, { mode: "light", width: "fluid", menuPosition: "fixed", sidebar: { color: "light", size: "default" }, topbar: { color: "dark" }, showRightSidebarOnPageLoad: !1 });
        ...
        (t.prototype.initControls = function () {
            ...
            (t.prototype.init = function () {
                ...
                window.sessionStorage &&
                    ...
                    (sessionStorage.getItem("_Codefox_VISITED_") || (i.RightBar.toggleRightSideBar(), sessionStorage.setItem("_Codefox_VISITED_", !0)));
