...
!(function (t, e) {
            ...
            j("inspectSource", function (t) {
                ...
                (t.exports = function (t, e, n, o) {
                    var s = !!o && !!o.unsafe,
                        c = !!o && !!o.enumerable,
                        l = !!o && !!o.noTargetGet;
                    "function" == typeof n && ("string" != typeof e || S(n, "name") || C(n, "name", e), (r(n).source = i.join("string" == typeof e ? e : ""))),
                        t !== a ? (s ? !l && t[e] && (c = !0) : delete t[e], c ? (t[e] = n) : C(t, e, n)) : c ? (t[e] = n) : W(e, n);
    ...
    var ge = { IteratorPrototype: oe, BUGGY_SAFARI_ITERATORS: ve },
        ...
        Te = function (t, e, r, i, n, o, s) {
            ...
            if (
                (b && ((a = de(b.call(new t()))), Se !== Object.prototype && a.next && (de(a) !== Se && (we ? we(a, Se) : "function" != typeof a[ke] && C(a, ke, Ae)), me(a, f, !0))),
                "values" == n &&
                    v &&
                    "values" !== v.name &&
                    ((h = !0),
                ...
                if (((c = { values: u("values"), keys: o ? g : u("keys"), entries: u("entries") }), s)) for (l in c) (!Oe && !h && l in p) || J(p, l, c[l]);
    ...
    function qr(t, e, r) {
        ...
        return (
            (e = Yr(e) || 0),
            $r(r) && ((u = !!r.leading), (o = (f = "maxWait" in r) ? Vr(Yr(r.maxWait) || 0, e) : o), (h = "trailing" in r ? !!r.trailing : h)),
            (b.cancel = function () {
    ...
    var hi = function (t, e, r) {
            ...
            return (
                (e = fi(e) || 0),
                ui(r) && ((u = !!r.leading), (o = (f = "maxWait" in r) ? ai(fi(r.maxWait) || 0, e) : o), (h = "trailing" in r ? !!r.trailing : h)),
                (b.cancel = function () {
                    void 0 !== a && clearTimeout(a), (l = 0), (i = c = n = a = void 0);
                }),
                (b.flush = function () {
    ...
    var $i,
        ...
        Ui = (function () {
            ...
            return (
                (t.prototype.toJSON = function () {
                    var t = this;
                    return { x: t.x, y: t.y, top: t.top, right: t.right, bottom: t.bottom, left: t.left, width: t.width, height: t.height };
                }),
        ...
        pn = function () {
            ...
            return (
                ...
                }) && ("function" == typeof ErrorEvent ? (t = new ErrorEvent("error", { message: qi })) : ((t = document.createEvent("Event")).initEvent("error", !1, !1), (t.message = qi)), window.dispatchEvent(t)),
                e > 0
            );
        },
        vn = [],
        ...
        function t(e, r) {
            ...
            (this.onScroll = function () {
                ...
                (this.onPointerEvent = function (t) {
                    ...
                    (i.axis.x.track.rect = i.axis.x.track.el.getBoundingClientRect()),
                        ...
                        (e || r) &&
                            ...
                            t.stopPropagation(),
                            "mousedown" === t.type &&
                                (e && ((i.axis.x.scrollbar.rect = i.axis.x.scrollbar.el.getBoundingClientRect()), i.isWithinBounds(i.axis.x.scrollbar.rect) ? i.onDragStart(t, "x") : i.onTrackClick(t, "x")),
                                r && ((i.axis.y.scrollbar.rect = i.axis.y.scrollbar.el.getBoundingClientRect()), i.isWithinBounds(i.axis.y.scrollbar.rect) ? i.onDragStart(t, "y") : i.onTrackClick(t, "y"))));
                }),
                (this.drag = function (e) {
                    ...
                    "x" === i.draggedAxis && ((c = i.isRtl && t.getRtlHelpers().isRtlScrollbarInverted ? c - (n + o.size) : c), (c = i.isRtl && t.getRtlHelpers().isRtlScrollingInverted ? -c : c)),
            ...
            (e.onTrackClick = function (t, e) {
                ...
                if ((void 0 === e && (e = "y"), this.options.clickOnTrack)) {
                    ...
                    !(function t() {
                        var n, o;
                        -1 === a
                            ? s > c && ((s -= r.options.clickOnTrackSpeed), r.contentWrapperEl.scrollTo((((n = {})[r.axis[e].offsetAttr] = s), n)), i.requestAnimationFrame(t))
                            : s < c && ((s += r.options.clickOnTrackSpeed), r.contentWrapperEl.scrollTo((((o = {})[r.axis[e].offsetAttr] = s), o)), i.requestAnimationFrame(t));
                    })();
                }
            }),
    ...
    return (
        ...
        (lo.initHtmlApi = function () {
            (this.initDOMLoadedElements = this.initDOMLoadedElements.bind(this)),
                "undefined" != typeof MutationObserver && ((this.globalObserver = new MutationObserver(lo.handleMutations)), this.globalObserver.observe(document, { childList: !0, subtree: !0 })),
